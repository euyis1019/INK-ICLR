...
|---|---|---|
| §1，图 1a，附录 A 表 1 | 四起点使用同一后续流程；Average/RegMean 的诊断准确率差距从 22.36 缩到 0.15 pp，预测 JS 从 0.13847 降到 0.00412；保留未拉平对照的 8.25 pp 终态差距 | [Issue #6](https://github.com/euyis1019/INK/issues/6#issuecomment-5648265351)；下方 R1、R3 |
...
| §1 → §2 的过渡 | 用当前学生确定修正几何，以固定专家作为目标锚点，接受后重新适配 | [Issue #8](https://github.com/euyis1019/INK/issues/8#issuecomment-5648267989)；由 #6/#7 综合，不当作额外实验 |
...
|---|---|---|
| `multistart.accuracy`、`multistart.pairs` | [derived_results.json](https://github.com/euyis1019/INK/blob/984679b6455c353fa9321684f2738a9a292ce1f8/reports/latex/cm_motivation_2pages/data/derived_results.json) | 图 1a、表 1、JS 与参数距离 |
